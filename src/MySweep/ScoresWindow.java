...
public class ScoresWindow extends JFrame implements DarkModeToggleable {
    ...
    private void initComponents() {
        clickableToggle.setUI(new MetalToggleButtonUI() {
            ...
            protected Color getSelectColor() {
                return (isDeleteMode)?Color.RED:((MineSweeper.isDarkMode())?PURPLE:super.getSelectColor());
            }
        });
