...
public class InstructionsWindow extends javax.swing.JFrame implements DarkModeToggleable {
    ...
    private void initComponents() {
        ...
        //sync toggle button status with dark mode status
        if(MineSweeper.isDarkMode())DMToggleButton.doClick();
