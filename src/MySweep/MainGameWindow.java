...
public class MainGameWindow extends javax.swing.JFrame implements DarkModeToggleable {
    ...
    public MainGameWindow(int w, int h, int bombNum, int lives) {
        ...
        this.lives = lives;
        bombCount = bombNum;
        grid = new Grid(Fieldx, Fieldy, bombCount, lives);
        displayTimer.scheduleAtFixedRate(timeDisplayTask, 0, 50);
    ...
    private void addGridActionListeners(){//i would have needed to pass in the toggle buttons for click action, and scrolls for zoom. this is better.
        grid.addCellListener(new MouseAdapter() {//add our listener to each cell.
            ...
            public void mousePressed(MouseEvent e) {
                ...
                //same thing but for right click, so no need for clickType 0 or marktoggle check
    ...
    private void initComponentsAndMiscListeners() {
        JMenuBar menuBar = new JMenuBar();
        JPanel menuPanel = new JPanel(new GridBagLayout());
        GridBagConstraints menuBagConstraints = new GridBagConstraints();
        Font ScoreAreaFontSize = new Font(MineSweeper.MAIN_FONT, 0, 20);
        ...
        Reset.addActionListener(new ActionListener() {//reset button
            ...
            public void actionPerformed(ActionEvent evt) {
                getContentPane().setPreferredSize(MainGameWindow.this.getContentPane().getSize());
                if((System.currentTimeMillis()-clickmemory)>1000){
                    clickmemory = System.currentTimeMillis();
                    grid.ResetBoard();
        ...
        toggleQuestionMarking.addActionListener(new ActionListener(){
