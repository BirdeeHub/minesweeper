...
javac -cp .\examplepluginloader.jar ..\src\MySweep\*.java -d ..\minesweeper_jar_in && cd ..\minesweeper_jar_in && jar -cvfe ..\minesweeper.jar MySweep.MineSweeper . ..\src\MySweep\Icons && cd ..
